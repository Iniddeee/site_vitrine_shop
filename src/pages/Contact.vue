...
const contactInfo = {
  address: {
    icon: MapPin,
    title: 'Adresse',
    details: ['FixPhone Suisse', 'Esplanade 15', '2900 Porrentruy', 'Suisse'],
  },
  phone: {
    icon: Phone,
    title: 'Téléphone',
    ...
    <section class="py-16 bg-white dark:bg-gray-800">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="rounded-lg overflow-hidden shadow-lg">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2696.8429289903537!2d7.099915315652937!3d47.42448797916637!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x478e2c0c4e4e4e4e%3A0x8ddca9ee380ef7e0!2sEsplanade%2015%2C%202900%20Porrentruy!5e0!3m2!1sen!2sfr!4v1234567890"
            width="100%"
            height="400"
            style="border: 0"
            allowfullscreen
